...
public class FairDataScience extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        String[] CHICAGO_CRIME_HEADERS = { "ID","Case Number","Date","Block","IUCR","Primary Type","Description"
        ...
        String[] GERMANY_CRIME_HEADERS = {"Art","1976","1977","1978","1979","1980","1981","1982","1983","1984"
        ...
        Reader chicagoFileReader = new FileReader(getClass().getResource("Crimes_-_2001_to_present.csv").getPath());
        Iterable<CSVRecord> chicagoRecords = CSVFormat.DEFAULT
            .withHeader(CHICAGO_CRIME_HEADERS)
            .withSkipHeaderRecord()
            .parse(chicagoFileReader);

        Reader germanyFileReader = new FileReader(getClass().getResource("Crimes_-_1976_to_2016.csv").getPath());
        ...
        lineChart.setTitle("Incidents of crime in the City of Chicago correlates with incidents of crime in Germany");
